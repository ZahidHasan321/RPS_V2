...
function Home() {
  ...
  return (
    <div className="mt-10">
      ...
      >
        <CardHeader>
          <CardTitle className="text-4xl text-center ">Course Info</CardTitle>
        </CardHeader>
        <CardContent>
          <p>
          ...
          <p>
            <span className="font-bold mr-1">Course Name : </span>{" "}
            <span> {course.courseName}</span>
          </p>
          <p>
            <span className="font-bold mr-1">Course Status : </span>{" "}
            <span> {course.courseStatus}</span>
          </p>

          <p>
            <span className="font-bold mr-1">Set A Examiner : </span>{" "}
            {course.setAExaminer == "" ? (
              <span
              ...
              >
                click here to assign examiner
              </span>
            ) : (
              <span>{course.setAExaminer}</span>
            )}
          </p>
          <p>
            <span className="font-bold mr-1">Set B Examiner : </span>{" "}
            {course.setBExaminer == "" ? (
              <span
                className="hover:cursor-pointer text-blue-600 font-bold"
                onClick={() => {
