          ...
          <div className="flex flex-wrap items-center  mx-auto p-4">
            ...
            <div className="">
              <ul className="font-medium  flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <a style={{ color: currentContent==content[0]?"blue":"" }}
                    onClick={() => {
                ...
                <li>
                  <a  
                  style={{ color: currentContent==content[1]?"blue":"" }}
                  onClick={() => {
                ...
                <li>
                  <a style={{ color: currentContent==content[2]?"blue":"" }}
                    onClick={() => {
                ...
                <li>
                  <a style={{ color: currentContent==content[3]?"blue":"" }}
                    onClick={() => {
